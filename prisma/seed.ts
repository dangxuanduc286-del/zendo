  ...
  const couponsSeed = [
    {
      ...
      description: "Giảm 20.000đ cho đơn hàng từ 299.000đ",
    ...
    },
    {
      ...
      description: "Giảm 30.000đ cho đơn hàng từ 499.000đ",
      type: "FIXED_AMOUNT" as const,
      scope: "ORDER" as const,
      value: 30000,
      maxDiscountAmount: null,
    ...
    },
    {
      ...
      description: "Giảm 80.000đ cho đơn hàng từ 1.499.000đ",
      type: "FIXED_AMOUNT" as const,
      scope: "ORDER" as const,
      value: 80000,
      maxDiscountAmount: null,
      minOrderAmount: 1499000,
      usageLimit: 2000,
      usagePerCustomer: 2,
      startsAt: new Date(),
      endsAt: new Date(Date.now() + 30 * 24 * 60 * 60 * 1000),
    ...
    },
    {
      ...
      description: "Giảm 100.000đ cho đơn điện tử từ 1.999.000đ",
      type: "FIXED_AMOUNT" as const,
      scope: "ORDER" as const,
      value: 100000,
      maxDiscountAmount: null,
      minOrderAmount: 1999000,
      usageLimit: 2000,
      usagePerCustomer: 2,
      startsAt: new Date(),
      endsAt: new Date(Date.now() + 45 * 24 * 60 * 60 * 1000),
    ...
    },
    {
      ...
      description: "Giảm 150.000đ cho đơn điện tử từ 2.999.000đ",
      type: "FIXED_AMOUNT" as const,
      scope: "ORDER" as const,
      value: 150000,
      maxDiscountAmount: null,
      minOrderAmount: 2999000,
      usageLimit: 1500,
      usagePerCustomer: 2,
      startsAt: new Date(),
      endsAt: new Date(Date.now() + 45 * 24 * 60 * 60 * 1000),
    ...
    },
    {
      ...
      description: "Giảm 200.000đ cho đơn điện tử từ 4.999.000đ",
      type: "FIXED_AMOUNT" as const,
      scope: "ORDER" as const,
      value: 200000,
      maxDiscountAmount: null,
      minOrderAmount: 4999000,
      usageLimit: 1000,
      usagePerCustomer: 2,
      startsAt: new Date(),
      endsAt: new Date(Date.now() + 45 * 24 * 60 * 60 * 1000),
    ...
    },
    {
      ...
      description: "Giảm 5%, tối đa 30.000đ cho đơn hàng từ 299.000đ",
    ...
    },
    {
      ...
      description: "Ưu đãi vận chuyển 20.000đ cho đơn hàng từ 199.000đ",
    ...
    },
    {
      ...
      description: "Ưu đãi vận chuyển 30.000đ cho đơn hàng từ 399.000đ",
      type: "FREE_SHIPPING" as const,
      scope: "SHIPPING" as const,
      value: 30000,
      maxDiscountAmount: 30000,
