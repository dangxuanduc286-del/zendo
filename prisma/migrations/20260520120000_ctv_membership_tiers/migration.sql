...
VALUES
  ('ctv_tier_bronze', 'bronze', 'CTV Đồng', 0, 10000000, 10000000, 200000, 8, 1,
  ...
  ('ctv_tier_silver', 'silver', 'CTV Bạc', 10000001, 20000000, 20000000, 500000, 9, 2,
   ...
   'medal', true, CURRENT_TIMESTAMP),
  ('ctv_tier_gold', 'gold', 'CTV Vàng', 20000001, 40000000, 40000000, 1000000, 10, 3,
  ...
  ('ctv_tier_diamond', 'diamond', 'CTV Kim Cương', 40000001, 100000000, 100000000, 2500000, 12, 4,
