        ...
        {tabs.map((item) => {
          ...
          return (
            <button
              ...
              className={`${CTV_SEGMENTED_ITEM} ${CTV_MOTION_CLASS.tab} focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-500/40 ${
