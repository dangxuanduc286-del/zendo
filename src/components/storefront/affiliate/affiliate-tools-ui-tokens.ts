...
export const AFFILIATE_TOOL_CARD = [
  ...
  "rounded-[18px] border border-slate-200/70 bg-white p-4 text-left",
  ...
  "lg:min-h-[5.25rem] lg:rounded-[20px] lg:p-[18px]",
].join(" ");
...
export const AFFILIATE_TOOL_URL_STRIP =
  "mt-3 break-all rounded-xl bg-slate-50/90 px-3.5 py-2.5 text-[12px] leading-relaxed text-slate-600 ring-1 ring-slate-100/90";
