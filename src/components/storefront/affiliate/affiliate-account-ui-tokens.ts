/** Mobile full-bleed panels — mirror customer account tab shell. */
export const AFFILIATE_MOBILE_PANEL_FLAT =
...
export const AFFILIATE_TAB_PANEL_CLASS = `w-full min-w-0 rounded-2xl border border-[#E2E8F0] bg-white p-4 shadow-sm sm:p-5 ${AFFILIATE_MOBILE_PANEL_FLAT}`;

export const AFFILIATE_SECTION_CARD =
  "rounded-2xl border border-slate-200/90 bg-white p-4 shadow-sm sm:p-5 max-lg:rounded-xl max-lg:border-slate-200/80";

export const AFFILIATE_PROMO_BLOCK =
