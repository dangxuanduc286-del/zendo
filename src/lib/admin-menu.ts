...
export const ADMIN_AFFILIATE_ANALYTICS_HREF = "/admin/affiliate-analytics";
export const ADMIN_AFFILIATE_FRAUD_HREF = "/admin/affiliate-fraud";
...
export const ADMIN_MENU_ITEMS: AdminMenuItem[] = [
  ...
  { label: "Affiliate Analytics", href: ADMIN_AFFILIATE_ANALYTICS_HREF },
