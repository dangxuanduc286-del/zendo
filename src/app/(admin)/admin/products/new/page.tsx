...
export const metadata: Metadata = {
  title: "Tạo sản phẩm | Quản trị Zendo.vn",
  description: "Tạo mới sản phẩm trong khu vực admin Zendo.vn.",
  ...
  return (
    <main className="w-full max-w-none space-y-4 bg-[#F8FAFC]">
      <header className="flex flex-wrap items-center justify-between gap-3 rounded-2xl border border-[#E2E8F0] bg-white p-5 shadow-sm sm:p-6">
        <div>
          <h1 className="text-2xl font-bold tracking-tight text-zinc-900 sm:text-3xl">Sản phẩm mới</h1>
