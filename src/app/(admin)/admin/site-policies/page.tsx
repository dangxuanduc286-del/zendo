...
import { adminCardBody, adminPageSubtitle, adminPageTitle, adminPrimaryButton, adminSecondaryButton } from "../../../../lib/admin-ui";
...
export default async function AdminSitePoliciesPage({
  ...
  return (
    <main className="w-full min-w-0 max-w-none space-y-5">
      <header className={`${adminCardBody} flex flex-wrap items-start justify-between gap-3`}>
        <div className="min-w-0 space-y-1">
          <h1 className={adminPageTitle}>Chính sách hệ thống</h1>
          <p className={`${adminPageSubtitle} max-w-xl`}>
