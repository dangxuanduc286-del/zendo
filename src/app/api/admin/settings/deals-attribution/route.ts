...
import { buildAttributionSummary } from "../../../../../lib/deals/attribution";
import { parseDealsMetricEventFromAuditLogRow, type DealsMetricEvent } from "../../../../../lib/deals/aggregation";
...
export async function GET(request: Request): Promise<NextResponse> {
  ...
  const summary = buildAttributionSummary(events);
  return NextResponse.json({ windowDays: days, since: since.toISOString(), summary });
}
